        ...
        <div class="container">
            <table width="100%" class="table table-bordered table-striped" style="font-size:11px;" border="1">
                ...
                <tr>
                    ...
                    <td>{{ $member->mem_id }}</td> <!-- Replace with actual column name -->
                    <td>{{ $member->name }}</td> <!-- Replace with actual column name -->
                    <td>{{ $member->crown_ambassador }}</td> <!-- Replace with actual column name -->
                    <td>{{ $member->total_director }}</td> <!-- Replace with actual column name -->
                    <td>{{ $member->pgbv }}</td> <!-- Replace with actual column name -->
                    <td align="center">{{ $member->total_unit }}</td> <!-- Replace with actual column name -->
                    <td align="center">{{ $member->royality }}</td> <!-- Replace with actual column name -->
                    <td align="center">{{ $member->total_amount }}</td> <!-- Replace with actual column name -->
                </tr>
                @empty
                <tr>
