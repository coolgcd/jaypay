        ...
        <!-- Brand and toggle get grouped for better mobile display -->
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav  navbar-right">
              ...
              <li><a href="{{ route('legal.index') }}">Legal</a></li>
              <li><a href="{{ route('member.login') }}">Login</a></li>
<!-- <li class="dropdown">
  <a href="/member/login" class="btn btn-orange border-none btn-rounded-corner btn-navbar dropdown-toggle" data-toggle="dropdown">
    Log in
    <span class="icon-on-button">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="/member/login" >Member Login</a></li>
              ...
              <!-- <li><a href="#" class="btn btn-orange border-none btn-rounded-corner btn-navbar">Log in<span class="icon-on-button"><i class="ion-ios-cloud-download-outline"></i></span></a></li> -->
            </ul>
          </div><!-- /.navbar-collapse -->
      ...
      <div id="home-slider" class="owl-carousel">
        <div>
          <div class="sliding-card-with-bottom-image text-center padding-top-90">
            <h2 class="cta-heading text-white">Jay Pay</h2>
            <p class="text-white slider-para">best property </p>
            <div class="cta-btn-group">
              <a class="btn btn-orange border-none btn-rounded-corner" href="#">Log in <span class="icon-on-button"></span></a>
            ...
            <div class="image-container text-center sm-display-none">
              <img class="img-responsive" src="{{ asset('assets/images/jaypay_slide_2.png') }}" alt="">
            </div>
          </div>
        </div>
          ...
          <div class="container">
            <div class="row">
              <div class="image-right-slide-bg clearfix" style="background-image:url(images/mockuo.png)">
                <div class="col-md-12">
                  <h2 class="cta-heading text-white">Jay Pay</h2>
                  <p class="text-white slider-para">best pay</p>
                  <div class="cta-btn-group">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="footer-left-content">
              <div class="logo-colored">
                <img src="images/Logo_color.png" alt="">test1
              </div>
              <div class="content">
                ...
                <p>+919090909090</p>
                <p>example@mail.com. example2@mail.com</p>
              </div>
            </div>
          </div>
          <div class="col-md-9">
          ...
          <!-- <div class="copyright-cta">
            <p class="text-uppercase">All rights Reserved By <a href="#"><span class="span text-violat ">Themewagon</span></a></p>
          </div> -->
        </div>
      </div>
