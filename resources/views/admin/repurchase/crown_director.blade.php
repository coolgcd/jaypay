        ...
        <div class="container">
            <table width="100%" class="table table-bordered table-striped" style="font-size:11px;" border="1">
                <tr style="background:#FFD3A8!important;">
                    ...
                    <td width="4%" nowrap><strong>Crown Director</strong></td>
                    ...
                    <td width="2%" align="center" nowrap><strong>Car Fund 6%</strong></td>
                    <td width="10%" align="center" nowrap><strong>Total Amount</strong></td>
                </tr>
                ...
                @if($members->count())
                    ...
                    <tr>
                        ...
                        <td>{{ $member->mem_id }}</td>
                        <td>{{ $member->name }}</td>
                        <td>{{ $member->crown_director }}</td>
                        <td>{{ $member->total_director }}</td>
                        <td>{{ $member->pgbv }}</td>
                        <td>{{ $member->total_unit }}</td>
                        <td>{{ number_format($member->car_fund, 2) }}</td>
