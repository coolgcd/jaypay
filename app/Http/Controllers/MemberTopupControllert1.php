...
//             // ✅ FIXED: ADD to both payamount and totpv (this was the main issue)
//             \Illuminate\Support\Facades\DB::table('member_binary')
//                 ->where('memid', $request->new_member_id)
//                 ->update([
//                     'is_laps'      => 0,
//                     'activatedate' => $activateDate,
//                     'payamount'    => \Illuminate\Support\Facades\DB::raw('COALESCE(payamount,0) + ' . (int)$pin->pinamt),  // ← FIXED: ADD instead of overwrite
...
//     // First-time activation (this part is fine as is)
//     \Illuminate\Support\Facades\DB::beginTransaction();
